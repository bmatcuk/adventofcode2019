...
//!     still just 2.  At first, a module of mass 1969 requires 654 fuel. Then, this fuel requires
//!     216 more fuel (654 / 3 - 2). 216 then requires 70 more fuel, which requires 21 fuel, which
//!     requires 5 fuel, which requires no further fuel. So, the total fuel required for a module
//!     of mass 1969 is 654 + 216 + 70 + 21 + 5 = 966.  The fuel required by a module of mass
...
fn calc_compounded_fuel(mass: u32) -> u32 {
    successors(calc_fuel(&mass), calc_fuel).sum()
}
