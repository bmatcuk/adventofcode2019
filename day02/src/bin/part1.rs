...
//!
//!     1,0,0,0,99 becomes 2,0,0,0,99 (1 + 1 = 2).  2,3,0,3,99 becomes 2,3,0,6,99 (3 * 2 = 6).
//!     2,4,4,5,99,0 becomes 2,4,4,5,99,9801 (99 * 99 = 9801).  1,1,1,4,99,5,6,0,99 becomes
//!     30,1,1,4,2,5,6,0,99.
//!
...
fn main() -> io::Result<()> {
    ...
    let mut program: Vec<i32> = Nums::new(reader).map(|i| i.unwrap()).collect();
    program[1] = 12;
    program[2] = 2;
